                    ...
                    {(provided, snapshot) => {
                        return (
                            <div className="block">
                                ...
                                >
                                    <FieldPill
                                        className={`flex dark:text-white pt-0.5 pb-0.5 pl-2 pr-2 mx-0 m-1 text-xs hover:bg-measure/20 rounded-md truncate border border-transparent ${
                                    ...
                                    {
                                        <FieldPill
                                            className={`dark:text-white pt-0.5 pb-0.5 pl-2 pr-2 mx-0 m-1 text-xs hover:bg-measure/20 rounded-md border-measure border truncate ${
