...
const DatasetFields: React.FC = (props) => {
    ...
    return (
        <div className="p-1 m-0.5 border border-gray-200 dark:border-gray-700 flex flex-col @md/main:flex-1 py-0 px-[0.6em]">
            ...
            <div className="flex-1 flex @md/main:flex-col max-h-[240px] @xl/main:max-h-[unset] pb-2 @md/main:pb-0 divide-gray-200 dark:divide-gray-700 divide-x @md/main:divide-x-0 @md/main:divide-y">
