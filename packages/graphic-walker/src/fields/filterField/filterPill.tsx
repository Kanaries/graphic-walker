...
const FilterPill: React.FC<FilterPillProps> = observer((props) => {
    ...
    return (
        <div
            className="text-foreground touch-none select-none items-stretch border box-border cursor-default flex flex-col text-xs min-w-[150px] overflow-y-hidden p-0 [&>*]:grow [&>*]:py-[0.2em] [&>*]:px-[0.5em] [&>header]:h-5 [&>header]:border-b [&>div.output]:min-h-5 [&>div.output>span]:overflow-y-hidden [&>div.output>span]:max-h-[4em]"
        ...
        >
            ...
            >
                ...
                <PencilSquareIcon
                    className="icon hidden flex-grow-0 flex-shrink-0 pointer-events-none text-muted-foreground"
                    role="presentation"
                    aria-hidden
                    width="1.4em"
                    height="1.4em"
