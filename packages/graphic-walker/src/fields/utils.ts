export function reorder(list: any[], originalIndex: number, targetIndex: number): any[] {
    const nextList = [...list];
...
export function move(originalList: any[], originIndex: number, targetList: any[], targetIndex: number): movedLists {
