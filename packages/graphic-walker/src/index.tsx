...
import type { IChartForExport, IGWHandler, IGWHandlerInsider, IGWProps, IMutField, IRow, ITableProps, IVizAppProps } from './interfaces';
...
export type { IGWProps, ITableProps, IVizAppProps, IMutField, IRow, IChartForExport };
