...
export const fieldStatServer = async (service: IComputationFunction, field: string, options: { values?: boolean; range?: boolean },
    preparationWorkflow: IDataQueryWorkflowStep[] = [],): Promise<IFieldStats> => {
