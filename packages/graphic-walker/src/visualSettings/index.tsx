...
const VisualSettings: React.FC<IVisualSettings> = ({ rendererHandler, darkModePreference }) => {
    ...
    }, [vizStore, canUndo, canRedo, defaultAggregated, markType, stack, interactiveScale, sizeMode, width, height, showActions, downloadPNG, downloadSVG, dark, zeroBaselineX, zeroBaselineY]);
