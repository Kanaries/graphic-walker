...
import { FilterWalker, IChartForExport } from '@kanaries/graphic-walker';
...
export default function GraphicWalkerComponent() {
    ...
    return <FilterWalker rawFields={fields} chart={spec as IChartForExport[]} dataSource={dataSource} dark={theme} />;
}
