...
import { getComputation, GraphicWalker, IVisFilter, TableWalker } from '@kanaries/graphic-walker';
...
export default function GraphicWalkerComponent() {
    ...
    return (
        <div className="flex flex-col gap-2">
            ...
            <TableWalker hideProfiling tableFilterRef={tableRef} fields={fields} data={dataSource} appearance={theme} pageSize={50} vizThemeConfig="g2" />
            <GraphicWalker hideProfiling fields={fields} data={dataSource} appearance={theme} vizThemeConfig="g2" />;
        </div>
    );
}
