...
import { GraphicRenderer, IChartForExport } from '@kanaries/graphic-walker';
...
export default function GraphicWalkerComponent() {
    ...
    return <GraphicRenderer rawFields={fields} chart={spec as IChartForExport[]} dataSource={dataSource} dark={theme} />;
}
